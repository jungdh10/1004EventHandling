    ...
    public void click(View v){
        ...
        switch (v.getId()){
            case R.id.save:
                ...
                try(FileOutputStream fos=openFileOutput("sample.txt", Context.MODE_PRIVATE);){
            ...
            case R.id.delete:
                ...
                break;
            case R.id.resource:
                try(InputStream fis= getResources().openRawResource(R.raw.res);
                ...
                break;
            case R.id.imagecopy:
                try(InputStream fis=getResources().openRawResource(R.raw.ral);
                    //기록할 수 있는 스트림 생성
                FileOutputStream fos=openFileOutput("ral.jpg", Context.MODE_PRIVATE);){
                    while(true){
